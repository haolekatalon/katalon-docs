...
## Jira Data Center
>
> Jira Data Center can also configure BDD settings the same way as Jira Server. You can add the **Katalon Gherkin** custom field for Jira Data Center, the same way as you do for Jira Server. For more details, see above: [Jira Server](https://docs.katalon.com/katalon-studio/docs/bdd-settings.html#jira-server).
