...
For further instructions and help, refer to [\[WebUI\] Text](https://docs.katalon.com/katalon-studio/docs/webui-set-text.html) and [\[WebUI\] Checkbox](https://docs.katalon.com/katalon-studio/docs/webui-check.html).
