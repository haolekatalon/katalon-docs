...
1. Open a test case in **Manual** view. Click on the dropdown icon of the **Add** button, then select **Call Test Case**.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/call-test-case/830-call-test-case.png" alt="call test case option" width="70%">
...
3.  A **Call Test Case** step is now added with the selected test case above as its target.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/call-test-case/830-call-test-case-manual.png" alt="call test case in manual view" alt="70%">
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/call-test-case/830-call-test-case-script.png" alt="call test case in script view" width="100%">
