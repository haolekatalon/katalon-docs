...
<table width="70%">
	<tbody>
		...
		<tr>
			<td>
				<p><a href="https://docs.katalon.com/katalon-studio/docs/testops-private-instance-integration.html">Katalon TestOps Private Instance</a></p>
			</td>
			<td>v8.3.5+</td>
		</tr>
		<tr>
			<td>
				<p><a href="https://docs.katalon.com/katalon-studio/docs/testcloud-integration.html">Katalon TestCloud</a></p>
			</td>
			<td>v8.2.5+</td>
		</tr>
	</tbody>
