...
* **Switch - Case**:
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/statements/830-switch-case-default.png" alt="switch statement" width="100%">
