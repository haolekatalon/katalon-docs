...
1. Katalon Studio allows users to **Set Type** for variables all at once if the variables have the same type. In this case, **Username** and **Password** have the same type as **Data Column**. Highlight both rows, click **Set Type > Data Column**.  
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/KS-830-Set-data-type.png" width="70%" alt="Set Data Type">

2. In the **Test Data** column, click on each row to choose the test data files for execution.
    
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/KS-830-Choose-test-data.png" width="70%" alt="Choose Test data for Data Type"> 

3. In the **Value** column, click on each row to specify the data field in the selected data file.
    
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/KS-830-Add-variables-value.png" width="70%" alt="Choose Value for Data Type">

4. Save the test suite when you finish.

    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/KS-830-Final-result.png" width="70%" alt="Final result">
...
1.  Highlight rows No. 1 and No.2 > click **Set Type** > select **Script Variable**.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/KS-830-Script-variables-option.png" width="30%" alt="Script Variable Option"> 
