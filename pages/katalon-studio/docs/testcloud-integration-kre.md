...
> Notes:
> 
> To use your proxy for TestCloud integration, you should configure both **Authentication Proxy** and **System Proxy** in **Preferences**. Learn more about proxy configurations at [Proxy Options](https://docs.katalon.com/katalon-studio/docs/console-mode-execution.html#proxy-options).
