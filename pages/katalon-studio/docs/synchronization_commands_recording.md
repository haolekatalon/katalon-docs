...
It is recommended to add synchronization while recording automation test cases in the [manual mode](https://docs.katalon.com/katalon-studio/docs/create-test-case.html#generate-test-steps-in-manual-view) or [script mode](https://docs.katalon.com/katalon-studio/docs/create-test-case.html#generate-test-steps-in-script-view). It is also a good practice to use wait commands to avoid execution failures. Download source code [here](https://github.com/katalon-studio/katalon-web-automation).
