...
For further instructions and help, refer to [WebUI Alert](https://docs.katalon.com/katalon-studio/docs/webui-accept-alert.html#description) and [Solving pop-up dialog issue with Katalon Studio](https://docs.katalon.com/katalon-studio/docs/pop_up_dialog_issue.html).