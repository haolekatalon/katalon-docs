---
title: "Use Katalon plugin for Jenkins Integration on Window/MacOS"
...
### Install the Katalon plugin

1. Install the **Katalon** plugin. Go to **Manage Jenkins > Manage Plugins > Available tab** and search for the **Katalon** plugin.

2. Select the plugin and click **Install without restart**.

   <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/jenkins-plugin-windows/K.S.E-8.2.5%20-%20Jenkins-download-Katalon-Testops-plugin.png" width=70% alt="Katalon plugin">
...
3. Input your command in the **Command arguments** box, for example:
   ...
   > Notices:
   >
   > When you use the **Katalon** plugin, you do not need to mention ```-noSplash``` and ```-runMode=console```.
